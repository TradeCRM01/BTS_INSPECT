  ...
  return (
    <OverlayPortal>
      <div className="overlay-backdrop">
        <div
          className="overlay-panel-xl border border-[#E5E7EB] flex flex-col max-h-[92vh]"
        ...
        >
          <div className="flex items-center justify-between px-5 py-3 border-b border-[#E5E7EB] shrink-0">
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-base font-semibold text-[#1A1A1A]">Document preview</h2>
              <span className="text-xs text-[#9CA3AF]">{data.docNumber}</span>
            </div>
            <div className="flex items-center gap-2">
              <button
                type="button"
          ...
          <div className="flex-1 min-h-0 bg-[#E5E7EB] p-3">
            {loading && (
