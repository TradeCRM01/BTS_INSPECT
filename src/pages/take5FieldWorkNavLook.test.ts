...
describe('Take 5 Field Work nav + JHA list row look', () => {
  ...
  it('paints the JHA list Take 5 row as a hairline paper entry, not a card-in-card', () => {
    ...
    expect(list).toContain('hub-jha-list-take5');
    ...
    expect(take5Row).toContain('hub-jha-list-take5-link');
    expect(take5Row).not.toContain('hub-jha-row');
    expect(take5Row).not.toContain('hub-jha-site');
    expect(take5Row).not.toContain('hub-jha-status');
