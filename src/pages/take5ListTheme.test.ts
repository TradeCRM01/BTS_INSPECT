...
describe('Take 5 list cards report_theme colours', () => {
  ...
  it('LOOK frames cover blank and saved Take 5 list cards only', () => {
    for (const rel of [
      'docs/look/take5-list-theme-blank-desktop.png',
      'docs/look/take5-list-theme-blank-ute.png',
      'docs/look/take5-list-theme-saved-desktop.png',
      'docs/look/take5-list-theme-saved-ute.png',
    ]) {
